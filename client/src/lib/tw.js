...
export const tw = {
  ...
  input:
    "w-full rounded-lg border border-line bg-surface px-3 py-2 text-sm text-stone-900 placeholder:text-stone-400 focus:border-accent/40 focus:outline-none focus:ring-2 focus:ring-accent/10",
  btn:
  ...
  btnOutline:
    "inline-flex items-center justify-center gap-1.5 rounded-lg border border-line bg-surface px-4 py-2 text-sm font-medium text-stone-700 transition-colors hover:border-accent/30 hover:bg-accent-soft/40",
  btnSm:
  ...
  btnOutlineSm:
    "inline-flex items-center justify-center gap-1.5 rounded-md border border-line bg-surface px-2.5 py-1.5 text-xs font-medium text-stone-600 transition-colors hover:border-accent/30 hover:bg-accent-soft/40",
